# TypeScript Dedicated MCP Starter (Node.js 22)

This starter is a TypeScript template for building a **dedicated** MCP server running on Node.js 22.
...
- `Dockerfile` – builds TS → JS (`dist/**`) and produces a minimal Node 22 container.
